...
// pub fn monochrome_bmp(data: &HeaderData) -> anyhow::Result<Image> {}

// pub fn bit4_palletized_bmp(data: &HeaderData) -> anyhow::Result<Image> {}

// pub fn bit8_palletized_bmp(data: &HeaderData) -> anyhow::Result<Image> {}
